		...
		<table>
			<tr>
				...
				<td><input class="box" type="text" name="id" placeholder="4~15 자리 영문/숫자 조합"
					onchange="checkId(this.value)"><br>
					<div id="checkId"></div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th>비밀번호 재확인</th>
				<td><input class="box" type="password" id="password2" name="passwordCheck"
			...
			<tr>
				...
				<td><select name="university">
						...
						<c:forEach var="uni" items="${universitys}">
							<option value="${uni.university}">${uni.university}</option>
						</c:forEach>
				</select></td>
			</tr>
			...
			<tr>
				...
				<td><label><input type="checkbox" id="allGrade"
						...
						class="setCheckedGrade">초등학생</label><br> <label><input
